...
The best fit for the data seems to come from the Random Forest model, with a 98% accuracy. 

The predictions made by the model on the 20 test cases are as follows:
